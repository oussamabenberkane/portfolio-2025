...
function Navigation() {
    return (
        <ul className="nav-ul">
            ...
            <li className="nav-li">
                <a href="#experiences" className="nav-link">Work</a>
            </li>
            <li className="nav-li">
            ...
            <div className="mx-auto c-space max-w-7xl">
                <div className="flex items-center justify-between py-2 sm:py-0">
                    ...
                    text-neutral-400 hover:text-white">
                        {/* Show logo on mobile only, hide on desktop */}
                        <img src="assets/logos/ouss.png" alt="logo" className="w-15 h-13 rounded-full sm:hidden" />
                        {/* Show full name on desktop only, hide on mobile */}
                        <span className="hidden sm:inline">Oussama Benberkane</span>
                    </a>
