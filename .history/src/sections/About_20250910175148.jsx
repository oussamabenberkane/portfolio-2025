    ...
    return <section className='c-space section-spacing'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
            ...
            <div className='flex items-end grid-default-color grid-1'>
                <img src="assets/ouss2.jpg" alt="" className='absolute scale-[1.3]' />
                <div className='z-10'>
                    <p className='headtext'> Hi, I'm Oussama</p>
                    <p className='subtext'>
                        an <strong>AI graduate</strong> and <strong>Backend Engineer</strong> who loves turning ideas into scalable systems. What excites me most is solving real problems with code, learning new things along the way, and sharing knowledge with others.
                    </p>
                </div>
