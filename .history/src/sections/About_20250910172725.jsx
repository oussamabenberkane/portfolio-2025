        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
            ...
            <div className='grid-default-color grid-2'>
                <div ref={grid2Container} className='flex items-center justify-center w-full h-full'>
                    ...
                    />
                    <Card
                        style={{ rotate: "-30deg", bottom: "50%", left: "0%" }}
                        text="AI"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "20deg", top: "55%", left: "0%" }}
                        text="Backend"
                        containerRef={grid2Container}
                    />
                    <Card
                    ...
                    />
                    <Card
                        style={{ rotate: "-20deg", top: "5%", left: "50%" }}
                        image="assets/logos/.png"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "-20deg", top: "30%", left: "60%" }}
                        image="assets/logos/tensorflowdocker.svg"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "20deg", top: "40%", left: "40%" }}
