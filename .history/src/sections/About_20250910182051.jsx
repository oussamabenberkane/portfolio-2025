            ...
            <div className='flex items-end grid-default-color grid-1 relative'>
                <img
                    ...
                    className="
                        ...
                        max-w-[180px]   // default (extra small screens)
                        sm:max-w-[220px]  // small screens
                        md:max-w-[260px]  // medium screens
                        lg:max-w-[300px]  // large screens
                        xl:max-w-[350px]  // extra large screens
  "
                />
