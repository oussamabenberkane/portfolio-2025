...
const About = () => {
    ...
    return <section className='c-space section-spacing'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
            {/* Grid 1 */}
            <div className='flex items-center justify-center grid-default-color grid-1 relative min-h-[400px] md:min-h-[450px]'>
                <img
                    src="assets/ouss2.png"
                    alt="Portrait of Oussama"
                    className="max-w-[200px] sm:max-w-[250px] lg:max-w-[300px] z-20"
                />

                <div className="absolute bottom-0 left-0 right-0 z-10 p-4 md:p-6 bg-gradient-to-t from-indigo/70 to-transparent">
                    <p className="headtext text-center">Hi, I'm Oussama</p>
