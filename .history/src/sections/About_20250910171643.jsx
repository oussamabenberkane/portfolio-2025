        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
            ...
            <div className='grid-default-color grid-2'>
                <div ref={grid2Container} className='flex items-center justify-center w-full h-full'>
                    ...
                    />
                    <Card
                        style={{ rotate: "10deg", top: "10%", left: "60%" }}
                        image="assets/logos/java.png"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "-15deg", top: "20%", left: "80%" }}
                        image="assets/logos/aws.svg"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "25deg", top: "40%", left: "20%" }}
                        image="assets/logos/python.svg"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "-10deg", top: "45%", left: "65%" }}
                        text="Data Science"
                        containerRef={grid2Container}
                    />
                    <Card
                    ...
                    />
                    <Card
                        style={{ rotate: "-20deg", top: "65%", left: "15%" }}
                        text="AI"
                        containerRef={grid2Container}
                    />
                    <Card
                    ...
                    />
                    <Card
                        style={{ rotate: "-5deg", top: "80%", left: "45%" }}
                        text="DevOps"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "30deg", top: "35%", left: "80%" }}
                        image="assets/logos/git.svg"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "-30deg", top: "25%", left: "40%" }}
                        text="Automation"
                        containerRef={grid2Container}
                    />
