        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
            ...
            <div className='grid-default-color grid-2'>
                <div ref={grid2Container} className='flex items-center justify-center w-full h-full'>
                    ...
                    />
                    <Card
                        style={{ rotate: "10deg", top: "8%", left: "45%" }}
                        image="assets/logos/java.png"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "-10deg", top: "12%", left: "80%" }}
                        image="assets/logos/aws.svg"
                        containerRef={grid2Container}
                    />

                    <Card
                        style={{ rotate: "15deg", top: "40%", left: "15%" }}
                        image="assets/logos/python.svg"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "-5deg", top: "38%", left: "50%" }}
                        text="Data Science"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "20deg", top: "42%", left: "80%" }}
                    ...
                    />
                    <Card
                        style={{ rotate: "12deg", top: "72%", left: "50%" }}
                        text="DevOps"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "-12deg", top: "68%", left: "80%" }}
                        image="assets/logos/docker.png"
                        containerRef={grid2Container}
                    />

                    <Card
                        style={{ rotate: "8deg", top: "55%", left: "33%" }}
                        image="assets/logos/git.svg"
                        containerRef={grid2Container}
                    />
                    <Card
                        style={{ rotate: "-8deg", top: "25%", left: "33%" }}
                        text="Automation"
                        containerRef={grid2Container}
                    />
            ...
            <div className='grid-default-color grid-5'>
                <div className='z-10 w-[50%]'>
                    ...
                    <p className='headText'>I specialize in a variety of languages that allow me to build things</p>
                </div>
