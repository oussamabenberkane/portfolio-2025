        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
            ...
            <div className='flex items-end grid-default-color grid-1'>
                ...
                <div className='z-10'>
                    ...
                    <p className='subtext'>
                        an <strong></strong>AI graduate and Backend Engineer who loves turning ideas into reliable, scalable systems. Over the past few years, I’ve worked on everything from cloud-based architectures to AI-driven applications, using tools like Java, Spring Boot, Python, and TensorFlow.
