...
const About = () => {
    ...
    return <section className='c-space section-spacing'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
            {/* Grid 1 */}
            <div className='flex items-end grid-default-color grid-1 relative min-h-[400px] md:min-h-[450px]'>
                <img
                    src="assets/ouss2.png"
                    alt="Portrait of Oussama"
                    className="absolute inset-0 m-auto max-w-[250px] lg:max-w-[300px] 
                   transform"
                />

                <div className="z-10 p-4 md:p-6 w-full">
