...
const ParallaxBackground = () => {
    ...
    const planetsX = useTransform(scrollYProgress, [0, 0.5], ["0%, 70%"]);
    const mountain2Y = useTransform(scrollYProgress, [0, 0.5], ["0%, 70%"]);
    const mountain1Y = useTransform(scrollYProgress, [0, 0.5], ["0%, 70%"]);
    return (
